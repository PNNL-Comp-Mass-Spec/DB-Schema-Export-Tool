...
DB_Schema_Export_Tool.exe F:\Cached_DBSchema /server:ProteinSeqs2 /DBList:Master_Sequences,Master_Seq_Scratch                       /sync:"F:\Documents\Projects\DataMining\Database_Schema\MTS"              /Git /Commit /L /LogDir:Logs
