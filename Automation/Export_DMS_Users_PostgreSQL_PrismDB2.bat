...
rem PgSQL_ExportUsers_PrismDB2.conf can be found at https://github.com/PNNL-Comp-Mass-Spec/DB-Schema-Export-Tool/blob/master/Automation/PgSQL_ExportUsers_PrismDB2.conf

F:
pushd "F:\Documents\Projects\DataMining\Database_Tools\DB_Schema_Export_Tool\Automation"

@echo on
..\bin\DB_Schema_Export_Tool.exe /conf:PgSQL_ExportUsers_PrismDB2.conf
