...
DB_Schema_Export_Tool.exe F:\Cached_DBSchema /server:albert       /DB:mt_template_01                                                /sync:"F:\My Documents\Projects\DataMining\Database_Schema\MTS\MT_Template"  /Git /L /LogFolder:Logs /NoSubfolder
DB_Schema_Export_Tool.exe F:\Cached_DBSchema /server:albert       /DB:pt_template_01                                                /sync:"F:\My Documents\Projects\DataMining\Database_Schema\MTS\PT_Template"  /Git /L /LogFolder:Logs /NoSubfolder
