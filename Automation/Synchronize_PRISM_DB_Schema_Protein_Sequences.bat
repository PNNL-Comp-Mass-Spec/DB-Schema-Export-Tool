...
@echo on
DB_Schema_Export_Tool.exe F:\Cached_DBSchema /server:Proteinseqs  /DBList:Protein_Sequences           /sync:"F:\Documents\Projects\DataMining\Database_Schema\DMS"     /Git /L /LogDir:Logs
