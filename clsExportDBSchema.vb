...
#End Region
    ...
    Private Sub ExportSQLServerConfiguration(ByRef objSqlServer As Microsoft.SqlServer.Management.Smo.Server, _
        ...
        With objSqlServer.Information
			...
			AppendToStringCollection(objStringCollection, "BuildClrVersion", .BuildClrVersionString)
        ...
        With objSqlServer.Configuration
			...
			AppendToStringCollection(objStringCollection, .Affinity64IOMask)
			...
			AppendToStringCollection(objStringCollection, .BlockedProcessThreshold)
            AppendToStringCollection(objStringCollection, .AweEnabled)
			AppendToStringCollection(objStringCollection, .C2AuditMode)
			AppendToStringCollection(objStringCollection, .CommonCriteriaComplianceEnabled)
			...
			AppendToStringCollection(objStringCollection, .DefaultBackupCompression)
			...
			AppendToStringCollection(objStringCollection, .DefaultTraceEnabled)
			AppendToStringCollection(objStringCollection, .DisallowResultsFromTriggers)
			AppendToStringCollection(objStringCollection, .ExtensibleKeyManagementEnabled)
			AppendToStringCollection(objStringCollection, .FilestreamAccessLevel)
            AppendToStringCollection(objStringCollection, .FillFactor)
			AppendToStringCollection(objStringCollection, .IndexCreateMemory)
			AppendToStringCollection(objStringCollection, .InDoubtTransactionResolution)
			...
			AppendToStringCollection(objStringCollection, .OptimizeAdhocWorkloads)
			...
			AppendToStringCollection(objStringCollection, .ServerTriggerRecursionEnabled)
